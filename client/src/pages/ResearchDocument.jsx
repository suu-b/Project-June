  ...
  const steps = [
    {
      ...
      description: "Upload the file and let June take care of answering your queries!",
      prime: true,
    },
    {
      id: 2,
      title: "Processing and Analysis",
      description: "June will pull out important points from your document and prepare to answer your queries",
    },
    {
      id: 3,
      title: "Explore!",
